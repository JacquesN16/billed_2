 ...
 */
 ...
 describe("Given I am connected as an employee and I am on NewBill Page", () => {
   ...
   describe("When I use good file extension", () => {
     test("Then isFileTypeValid must return true", () => {
       const fileExtension = "jpg"
       const container = new NewBill({ document, onNavigate, store: null, localStorage })
       const isFileTypeValid = jest.fn(container.isFileTypeValid)
       expect(isFileTypeValid(fileExtension)).toBeTruthy()
 
     })
   })
 
   describe("When the form is not filled and I click on button send", () => {
   ...
   describe("When the form is filled with good format except for input file", () => {
   ...
   describe("When I use file with bad extension", () => {
     test("Then I should stay on NewBill Page", () => {
       ...
       expect(handleChangeFile(event)).toBe(null)
     })
   })
   ...
   describe("When I use file with good extension", () => {
     test("Then I should be redirect on Bills Page", () => {
       ...
       expect(handleChangeFile(event)).not.toBe(null)
     })
   })
